...
class Recoder(object):
	def __init__(self, save_path, sim=True):
		...
		if sim:
<<<<<<< HEAD
			self.saveTo=os.path.join(save_path, 'record/sim/ep4')
=======
			self.saveTo=os.path.join(save_path, 'record/sim_record_new_queue')
>>>>>>> jackal_sim
		else:
			self.saveTo=os.path.join(save_path, 'record/real/trial8')
		self.savePath = save_path

		# self.loadFrom = 'data/unicycle/selfAttn_truePred_noiseActt/record/sim_recordings/ep0-1/action.csv'
<<<<<<< HEAD
		self.loadFrom = 'data/jackal_dense_trial/record/sim_record_new_queue/ep4/action.csv'
=======
		self.loadFrom = 'data/jackal_0to4human_visible0d8_randHumanVpref_bicycleDyn_fewerBlockage/record/real_world_frame/4human_3/action.csv'
>>>>>>> jackal_sim
...
<<<<<<< HEAD
		savePath = self.saveTo
=======
		# savePath=os.path.join(self.saveTo,'closed_loop_0human')
...
<<<<<<< HEAD
		print("csv written to", savePath)
=======
		print("csv written", savePath)
>>>>>>> jackal_sim
		self.clear()
