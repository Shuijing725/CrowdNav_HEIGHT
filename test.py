...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='data/ours_RH_HH_hallwayEnv')
	...
	parser.add_argument('--test_model', type=str, default='104200.pt')
