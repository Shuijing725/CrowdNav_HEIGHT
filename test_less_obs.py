...
def main():
	...
	# parser.add_argument('--test_model', type=str, default='103600.pt')
	# use nn or not
	...
	if test_args.visualize or test_args.save_slides:
		...
		log_file = os.path.join(test_args.model_dir, 'test', 'test_'+test_args.test_model+config.env.scenario+'_less_obs.log')
