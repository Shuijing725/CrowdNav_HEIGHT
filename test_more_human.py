...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='data/randEnv_8to12smallobs_5to9human_0to2staticHuman_goal5to6_robCir4/homo_transformer')
	...
	parser.add_argument('--test_model', type=str, default='237600.pt')
