...
class ORCA(Policy):
    ...
    def predict(self, state):
        ...
        # todo: the human_num in 2 adjacent episodes might be the same -> fail to delete previous sim between episodes
        #  -> the agent properties such as radius and v_pref carry over between episodes
        ...
        if self.sim is None:
            ...
            # # add static obstacles to simulation
            ...
            self.sim.setAgentMaxSpeed(0, self_state.v_pref)
